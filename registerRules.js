...
const registerAvailableSpecialists_1 = require("./registerAvailableSpecialists");
const register = (game) => {
    (0, registerAvailableSpecialists_1.default)(game.availableSpecialists);
    game.rules.register(...(0, building_complete_1.default)(game.engine), ...(0, can_be_worked_1.default)(game.cities, game.units, game.workedTiles), ...(0, captured_1.default)(game.cities, game.units, game.cityGrowth, game.cityBuilds, game.engine, game.playerWorlds, game.workedTiles, game.specialists, game.availableSpecialists), ...(0, cost_1.default)(game.cityGrowth, game.playerGovernments, game.units), ...(0, created_1.default)(game.tileImprovements, game.cityBuilds, game.cityGrowth, game.cities, game.playerWorlds, game.rules, game.availableCityBuildItems, game.engine, game.workedTiles, game.specialists, game.availableSpecialists), ...(0, destroyed_1.default)(game.tileImprovements, game.cities, game.engine, game.units, game.workedTiles, game.specialists), ...(0, food_exhausted_1.default)(), ...(0, food_storage_1.default)(game.rules), ...(0, grow_1.default)(game.cityGrowth, game.playerWorlds, game.workedTiles, game.specialists, game.availableSpecialists), ...(0, growth_cost_1.default)(), ...(0, process_yield_1.default)(game.cityBuilds, game.cityGrowth, game.units, game.rules), ...(0, shrink_1.default)(game.cityGrowth, game.playerWorlds, game.workedTiles, game.specialists), ...(0, tiles_1.default)(), ...(0, tile_reassigned_1.default)(game.playerWorlds, game.cityGrowth, game.workedTiles, game.specialists, game.availableSpecialists), ...(0, yield_1.default)(game.cityImprovements, game.playerGovernments, game.specialists), ...(0, action_1.default)(game.cityBuilds, game.cities, game.specialists), ...(0, defeated_1.default)(game.cities, game.cityGrowth, game.engine), ...(0, moved_1.default)(game.rules, game.workedTiles), ...(0, unsupported_1.default)());
};
