...
const getRules = (cityGrowthRegistry = CityGrowthRegistry_1.instance, playerWorldRegistry = PlayerWorldRegistry_1.instance) => [
    ...
    new Grow_1.default(new Criterion_1.default((cityGrowth) => cityGrowth.city().tilesWorked().length < cityGrowth.size() + 1), new Effect_1.default((cityGrowth) => assignWorkers_1.default(cityGrowth.city(), playerWorldRegistry, cityGrowthRegistry))),
