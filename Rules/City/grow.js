...
const getRules = (cityGrowthRegistry = CityGrowthRegistry_1.instance, playerWorldRegistry = PlayerWorldRegistry_1.instance, workedTileRegistry = WorkedTileRegistry_1.instance) => [
    ...
    new Grow_1.default('civ1-city:city/grow/assign-worker', new Criterion_1.default((cityGrowth) => cityGrowth.city().tilesWorked().length < cityGrowth.size() + 1), new Effect_1.default((cityGrowth) => (0, assignWorkers_1.assignWorker)(cityGrowth.city(), playerWorldRegistry, cityGrowthRegistry, workedTileRegistry))),
    new Grow_1.default('civ1-city:city/grow/reduce-workers', new Criterion_1.default((cityGrowth) => cityGrowth.city().tilesWorked().length > cityGrowth.size() + 1), new Effect_1.default((cityGrowth) => (0, assignWorkers_1.reduceWorkers)(cityGrowth.city(), cityGrowth).forEach((tile) => workedTileRegistry.unregisterByTile(tile)))),
];
