...
const getRules = (ruleRegistry = RuleRegistry_1.instance, workedTileRegistry = WorkedTileRegistry_1.instance) => [
    new Moved_1.default('civ1-city:unit/moved/release-occupied-worked-tile', new Criterion_1.default((unit) => unit.moves().value() === 0), new Criterion_1.default((unit, action) => workedTileRegistry.tileIsWorked(action.to())), new Criterion_1.default((unit, action) => {
